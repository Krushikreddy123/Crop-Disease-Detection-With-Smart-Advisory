...
RECOMMENDATION_LIBRARY = {
    ...
    "leaf_mold": {"chemical_treatment": ["Use a labeled fungicide such as chlorothalonil or mancozeb with full canopy coverage.", "Repeat at 5-7 day interval if greenhouse humidity stays high.", "Target the underside of leaves where mold growth is strongest."], "organic_treatment": ["Remove infected leaves and improve ventilation immediately.", "Use bio-fungicide products only after lowering humidity around the crop.", "Avoid overcrowded pruning that traps moisture inside the canopy."], "recommended": ["Chlorothalonil", "Mancozeb", "Copper-based fungicide"], "dosage": "Apply the selected fungicide at the labeled dose and ensure good underside leaf coverage; repeat in 5-7 days if humidity remains high.", "irrigation": "Water early in the day and avoid overhead irrigation that keeps leaves wet for long hours.", "fertilizer": "Avoid excess nitrogen that creates dense canopy growth and poor airflow.", "weather": "High humidity and poor ventilation favor fast leaf mold development, especially in protected structures.", "spread": "Spread risk is high when humidity stays above normal and the crop canopy remains dense.", "prediction": "If humidity remains high over the next 7 days, leaf mold can move quickly through the middle and lower canopy.", "best_spray_time": "Spray early morning after leaves dry, and improve ventilation immediately after treatment.", "safety_precautions": ["Wear gloves, mask, and goggles while spraying inside greenhouse or dense canopy areas.", "Keep ventilation open during and after spray to reduce inhalation exposure.", "Do not spray on dripping-wet foliage because runoff reduces coverage and wastes product.", "Wash hands, face, and spraying tools after treatment is completed."]},
    "septoria": {"chemical_treatment": ["Begin a protectant fungicide schedule with mancozeb or chlorothalonil.", "Repeat at 5-7 day interval during continued spotting pressure.", "Cover lower leaves well because infection usually starts from the bottom canopy."], "organic_treatment": ["Remove infected lower leaves and keep mulch over exposed soil.", "Use compost extract or bio-fungicide only after sanitation and pruning.", "Keep tools clean and avoid working in the field while leaves are wet."], "recommended": ["Mancozeb", "Chlorothalonil", "Copper fungicide"], "dosage": "Use the chosen protectant fungicide as per label, usually on a 5-7 day interval when disease pressure stays active.", "irrigation": "Use drip or furrow irrigation to reduce splash from soil to lower leaves.", "fertilizer": "Maintain balanced nutrition with enough potash to support foliage strength without forcing soft growth.", "weather": "Rain splash and long periods of leaf wetness will increase new spot formation.", "spread": "Spread risk is medium to high because spores move upward from infected residue and lower leaves.", "prediction": "If rainy or humid weather continues during the next 7 days, defoliation may increase quickly from the bottom upward.", "best_spray_time": "Spray in the early morning after dew dries so the lower canopy gets better deposit coverage.", "safety_precautions": ["Wear gloves and a mask before mixing protectant fungicides.", "Keep spray pressure moderate to avoid drift onto nearby people or animals.", "Do not enter the sprayed area until the foliage dries and label instructions allow re-entry.", "Clean harvesting and pruning tools after working around infected plants."]},
    ...
    "target_spot": {"chemical_treatment": ["Apply a protectant plus systemic fungicide rotation suitable for target spot.", "Increase spray coverage in the lower and inner canopy where lesions build up first.", "Repeat on the labeled interval during warm humid weather."], "organic_treatment": ["Remove heavily spotted leaves and improve row ventilation.", "Use mulch to reduce movement of spores from soil splash.", "Avoid keeping leaves wet late into the evening."], "recommended": ["Azoxystrobin", "Mancozeb", "Chlorothalonil"], "dosage": "Apply the selected fungicide as per label and maintain good lower-canopy coverage at each spray.", "irrigation": "Avoid late-day overhead irrigation and keep leaf wetness periods short.", "fertilizer": "Keep nutrition balanced and avoid dense overgrown foliage that reduces airflow.", "weather": "Warm humid conditions strongly favor new target spot lesions and lesion expansion.", "spread": "Spread risk is medium to high when humidity stays elevated and sanitation is delayed.", "prediction": "If warm humid weather continues over the next 7 days, spotting and leaf drop may increase in the lower canopy.", "best_spray_time": "Spray during calm early morning conditions for better lower-canopy penetration.", "safety_precautions": ["Wear gloves, mask, and full sleeves while mixing and spraying fungicides.", "Do not spray in strong wind because good coverage is needed on the lower canopy.", "Keep food, feed, and water sources away from the spray area.", "Follow the re-entry interval printed on the fungicide label before working in the field."]},
    "yellowleaf": {"chemical_treatment": ["There is no cure for infected leaves, so focus on vector control using recommended whitefly insecticides.", "Rotate systemic insecticides only according to local label guidance.", "Remove severely affected plants early to reduce source pressure."], "organic_treatment": ["Use yellow sticky traps and reflective mulch to reduce whitefly movement.", "Spray neem oil 3-5 ml/L to reduce vector feeding pressure.", "Destroy badly infected plants outside the growing area."], "recommended": ["Imidacloprid", "Thiamethoxam", "Neem oil"], "dosage": "Use the selected whitefly-control insecticide exactly as per label and repeat only after scouting confirms need.", "irrigation": "Maintain even moisture and avoid plant stress because stressed plants decline faster under virus pressure.", "fertilizer": "Use balanced nutrition with enough potash and avoid excessive nitrogen that attracts whiteflies.", "weather": "Warm dry weather supports faster whitefly activity, so increase scouting frequency in such periods.", "spread": "Spread risk is very high through whitefly movement and infected planting material.", "prediction": "Over the next 7 days, nearby healthy plants may begin curling and yellowing if whitefly control is delayed.", "best_spray_time": "Spray vector control insecticide in the early morning or late afternoon when whitefly activity is easier to target.", "safety_precautions": ["Wear gloves, long sleeves, and a mask during insecticide mixing and spraying.", "Avoid spraying when bees are active; prefer early morning or late afternoon windows.", "Do not leave infected uprooted plants inside the field because vectors can continue feeding on them.", "Wash exposed skin and clothes after handling infected plants or insecticides."]},
    "mosaic_virus": {"chemical_treatment": ["No curative spray will fix infected leaves, so remove infected plants and focus on sanitation.", "Disinfect tools, trays, and support wires after working in affected rows.", "Control sap-sucking pests when needed, based on local scouting."], "organic_treatment": ["Wash hands with soap before handling healthy plants after touching infected ones.", "Use clean seedlings and avoid tobacco contamination near tomato plants.", "Rogue badly infected plants and dispose of them away from the crop."], "recommended": ["Disinfectant for tools", "Neem oil for vector suppression", "Labeled insecticide only if vectors are present"], "dosage": "No disease-curing dosage is available; use sanitation products and any vector-control spray only as directed on the label.", "irrigation": "Maintain steady irrigation to reduce plant stress but avoid moving sap through rough handling during wet operations.", "fertilizer": "Use balanced nutrition and avoid overfeeding nitrogen, which can attract more vector activity.", "weather": "Handling plants in warm dry weather can still spread contamination if tools and hands are not cleaned.", "spread": "Spread risk is high through contaminated hands, tools, and infected seedlings.", "prediction": "If sanitation is delayed over the next 7 days, more plants can show mosaic and distortion symptoms.", "best_spray_time": "Prioritize sanitation first; if vector spray is needed, apply during calm early morning or late afternoon hours.", "safety_precautions": ["Disinfect hands and cutting tools before moving from infected plants to healthy ones.", "Wear gloves while removing infected plants to reduce sap transfer.", "Bag and remove infected plant material instead of leaving it on the soil surface.", "Keep tobacco products away from the crop handling area."]},
